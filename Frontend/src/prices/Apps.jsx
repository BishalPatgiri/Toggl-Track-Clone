...
const Apps = () => {
  return (
    <Box mt="50px" bg="#f7d8f3" color={"black"} textAlign="center">
      ...
      <div className="gridwala">
        <div style={{width:"90%",margin:"auto"}}>
          <Image style={{width:"100px",margin:"auto",marginTop:"40px"}} src="https://public-assets.toggl.com/b/static/2038847e62390356691df99de87fece9/368f9/icon-mobile.avif"/>

...
const Signupm = () => {
  return (
    ...
    <Text mt="30px" fontSize={"18px"} color="white">Already have an account? <Link style={{color:"pink.800",textDecoration:"underline"}} to={"/login"}>Login Here</Link></Text>
  </Box>
  ...
  <Stack direction={{lg:"row",md:"column",base:"column"}} >
      ...
      <Box h={"50px"} backgroundColor="pink.400" display={"flex"} justifyContent="start" alignItems={"center"} pl="2%">
